...
public class OgnlTest2 {
	...
	public static void main(String[] args) throws OgnlException {
		...
		out.println(Ognl.getValue("@com.zlj.struts2.ognl.OgnlBean@staticProperty", context));
		out.println(Ognl.getValue("@com.zlj.struts2.ognl.OgnlBean@staticMethod()", context));
